...
<svelte:head>
	<title>설정 - Snow-X</title>
	<meta name="description" content="Snow-X의 개인정보, 계정, 디스플레이, 알림, 개인정보 보호 설정을 관리하세요." />
	<meta name="robots" content="noindex, nofollow" />

	<!-- Open Graph -->
	<meta property="og:title" content="설정 - Snow-X" />
	<meta
		property="og:description"
		content="Snow-X의 개인정보, 계정, 디스플레이, 알림, 개인정보 보호 설정을 관리하세요."
	/>
	...
	<meta name="twitter:title" content="설정 - Snow-X" />
	<meta
