...
<svelte:head>
	<title>{data.profile.name} (@{data.profile.handle}) - Snow-X</title>
	<meta
		name="description"
	...
	<!-- Open Graph -->
	<meta property="og:title" content="{data.profile.name} (@{data.profile.handle}) - Snow-X" />
	<meta
		property="og:description"
		content={data.profile.bio || m.profile_meta_description_fallback({ name: data.profile.name })}
	/>
	<meta property="og:type" content="profile" />
	<meta property="og:url" content="https://snow-x.ink/{data.profile.handle}/profile" />
	<meta
		property="og:image"
		content={data.profile.banner_image || data.profile.profile_image || 'https://snow-x.ink/og-default.png'}
	/>
