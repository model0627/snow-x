...
<svelte:head>
	<title>최신 포스트 - Snow-X</title>
	<meta name="description" content="Snow-X에서 최신으로 작성된 포스트들을 확인해보세요." />

	<!-- Open Graph -->
	<meta property="og:title" content="최신 포스트 - Snow-X" />
	<meta property="og:description" content="Snow-X에서 최신으로 작성된 포스트들을 확인해보세요." />
	<meta property="og:type" content="website" />
	<meta property="og:url" content="https://snow-x.ink/latest" />
	<meta property="og:image" content="https://snow-x.ink/og-default.png" />

	<!-- Twitter Card -->
	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:title" content="최신 포스트 - Snow-X" />
	<meta name="twitter:description" content="Snow-X에서 최신으로 작성된 포스트들을 확인해보세요." />
	<meta name="twitter:image" content="https://snow-x.ink/og-default.png" />

	<link rel="canonical" href="https://snow-x.ink/latest" />
</svelte:head>
