...
<svelte:head>
	<title>{data.post.title} - {data.author.name} - Snow-X</title>
	...
	<meta property="og:url" content="https://snow-x.ink/@{data.author.handle}/post/{data.post.slug}" />
	<meta property="og:image" content={data.post.thumbnail_image || 'https://snow-x.ink/og-default.png'} />
	<meta property="og:site_name" content="Snow-X" />
	...
	<meta name="twitter:image" content={data.post.thumbnail_image || 'https://snow-x.ink/og-default.png'} />
</svelte:head>
