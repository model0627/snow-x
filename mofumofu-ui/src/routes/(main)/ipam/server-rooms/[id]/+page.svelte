<script lang="ts">
	...
	import { ArrowLeft, Server, HardDrive, Plus, Edit, Trash2, Settings, Activity, Shield, Thermometer, Droplets, Calendar } from '@lucide/svelte';
...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
	...
	{:else if serverRoom}
		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
				...
				<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div class="space-y-4">
						<div>
							...
							<p class="text-gray-900 dark:text-gray-100 font-medium">서울 DC-2</p>
						</div>
						<div>
			...
			<!-- Monitoring Settings -->
			<div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
				<h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">모니터링 설정</h2>
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
				...
				<div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
					...
					<p class="text-sm text-gray-500 dark:text-gray-400 mt-1">0개의 랙</p>
				</div>
				...
				<div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
					...
					<p class="text-sm text-gray-500 dark:text-gray-400 mt-1">0개의 디바이스</p>
				</div>
			</div>
